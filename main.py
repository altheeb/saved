...
api_id = 25595585
api_hash = "fdd04c2c922512681c1a0515f465150b"
...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
	...
	reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("السورس", url="https://t.me/e_b51")]]), reply_to_message_id=message.id)
